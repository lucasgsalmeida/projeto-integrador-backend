...
public record UsuarioRespondeDTO(Long id, Long idEscritorio, Long idDepartamento, String nome, String usuario, String senha, UserRole role) {

    public UsuarioRespondeDTO(Usuario user) {
