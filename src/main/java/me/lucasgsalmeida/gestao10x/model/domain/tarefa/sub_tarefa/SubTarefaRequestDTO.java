...
public record SubTarefaRequestDTO(Long idUsuario, Long idDepartamento, StatusTarefa statusTarefa, Date dataInicio, Date dataFim, List<ComentarioSubTarefa> comentarios) {
}
