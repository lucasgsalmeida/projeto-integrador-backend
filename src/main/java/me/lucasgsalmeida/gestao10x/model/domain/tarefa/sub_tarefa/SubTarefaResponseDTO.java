...
public record SubTarefaResponseDTO(Long id, Long idEscritorio, Long idUsuario, Long idDepartamento, StatusTarefa statusTarefa, Date dataInicio, Date dataFim, List<Comentario> comentarios) {
